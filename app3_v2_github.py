...
# load the model.pkl
# path = r'C:\Users\User\OneDrive\Data Science\DataScience\DSSI\Day 2\ap3-main_corrected\ap3-main\model.pkl'
...
def prediction(int_rate, emp_length, annual_inc, delinq_2yrs, fico_range_high,revol_bal, open_acc):
	...
	if prediction == 0:
		pred = 'The application for Loan is Rejected'
	else:
		pred = 'The applcication for Loan is Approved'
	return pred
